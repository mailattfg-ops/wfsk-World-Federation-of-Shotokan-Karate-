            ...
            <div className="w-full mx-auto space-y-8">
                ...
                <div className="bg-white rounded-lg p-6 sm:p-10 shadow-sm">
                    ...
                    <div className="flex flex-col lg:flex-row items-stretch">
                        ...
                        <div className="flex-shrink-0 lg:w-1/4 flex justify-center lg:justify-end lg:items-center border-b lg:border-b-0 lg:border-r border-[#000000] pb-1 lg:pb-0 lg:pr-8">
                            <h2 className="text-4xl sm:text-5xl font-bold text-black leading-tight tracking-tight text-center lg:text-right w-full">
                                Who <br />
                                we are
                            </h2>
                        </div>
                        ...
                        <div className="flex-grow pl-0 lg:pl-8 pt-1 lg:pt-0 flex justify-center lg:justify-start">
                            <div className="flex flex-col sm:flex-row items-center sm:items-stretch max-w-2xl w-full">
                                {/* Logo */}
                                <div className="w-[120px] h-[120px] sm:w-[200px] sm:h-auto relative flex-shrink-0">
                                ...
                                <div className="flex flex-col gap-1 w-fit">
                                    {/* English Title */}
                                    <h3 className="text-[#E81E26] font-(family-name:--font-belanosima) font-normal uppercase whitespace-nowrap leading-none text-center sm:text-left"
                                        style={{ fontSize: "clamp(16px, 2.0vw, 28px)" }}>
                                        World Federation of Shotokan Karate
                                    </h3>


                                    {/* Japanese Text */}
                                    <div className="w-full flex justify-between items-center text-black font-bold text-[18px] sm:text-2xl  leading-none">
                                        <div className="h-[2px] sm:h-[3px] w-8 sm:w-20 bg-black"></div>
                                    ...
                                    <div className="flex flex-col xs:flex-row items-center justify-center sm:justify-start mt-1 gap-2 xs:gap-0">
                                        ...
                                        <span className="text-[14px] font-bold text-black ml-0 xs:ml-1 font-geist-sans whitespace-nowrap">World Headquarters - Dubai , UAE</span>
                                    </div>
                                </div>
                            </div>
                        </div>
