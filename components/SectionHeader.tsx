...
export function SectionHeader({ title, children }: SectionHeaderProps) {
    return (
        <div className="bg-white rounded-lg p-6 sm:p-10 shadow-sm flex flex-col md:flex-row items-center md:items-center gap-2 sm:gap-6 text-center md:text-left">
            ...
            <div className="md:hidden w-28 h-[1px] bg-[#000000] mx-auto"></div>
            <div className="hidden md:block w-px h-32 bg-black grow-0 shrink-0"></div>

            <div className="w-full md:w-3/4 max-w-2xl xl:max-w-4xl mx-auto md:mx-0">
                <div className="text-[#7C7C7C] font-(family-name:--font-geist-sans) text-[12px] md:text-[14px] lg:text-[16px] xl:text-[20px]">
                    {children}
                </div>
            </div>
        </div>
