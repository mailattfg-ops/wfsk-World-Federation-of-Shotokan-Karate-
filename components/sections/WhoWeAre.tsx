            ...
            <div className="w-full mx-auto space-y-4 sm:space-y-8">
                ...
                <div className="bg-white rounded-lg p-4 sm:p-10 shadow-sm overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row items-stretch">
                        ...
                        <div className="flex-shrink-0 lg:w-1/4 flex flex-col items-center lg:items-end lg:justify-center lg:border-r lg:border-black pb-0 lg:pb-0 pr-0 lg:pr-8">
                            <h2 className="text-2xl sm:text-5xl font-bold text-black leading-none tracking-tight text-center lg:text-right w-full">
                                Who <br />
                                we are
                            </h2>
                            {/* Horizontal Line below title on mobile */}
                            <div className="lg:hidden w-24 h-[1px] bg-black/50 mt-2 mb-4 mx-auto"></div>

                        </div>

                        {/* Right: Header Content (Logo, Text, Badges) */}
                        <div className="flex-grow pl-0 lg:pl-8 pt-0">
                            {/* Removed w-full from mx-auto wrapper to allow true centering on mobile */}
                            <div className="flex flex-row items-center lg:items-center justify-center lg:justify-start w-full max-w-2xl mx-auto lg:mx-0 gap-0 sm:gap-6">
                                ...
                                <div className="flex flex-col gap-0.4 sm:gap-1 w-fit items-stretch text-left">
                                    ...
                                    <div className="text-[#E81E26] font-(family-name:--font-belanosima) font-normal uppercase leading-none text-[10px] sm:text-lg lg:text-xl whitespace-nowrap">
                                    ...
                                    <div className="w-full flex items-center justify-center text-black font-bold leading-none gap-0.5 sm:gap-2">
                                        <div className="h-[0.5px] sm:h-[2px] grow bg-black"></div>
                                        <span className="shrink-0 text-[10px] sm:text-[18px] lg:text-2xl tracking-tighter sm:tracking-normal">ショトカ ン 空 手 の 世 界 連 盟</span>
                                        <div className="h-[0.5px] sm:h-[2px] grow bg-black"></div>
                                    </div>

                                    {/* Red Box Section */}
                                    <div className="bg-[#E81E26] text-white rounded-[2px] sm:rounded-[4px] px-1 sm:px-2 py-1 sm:py-1 mt-0 w-full">
                                        <p className="font-medium text-center leading-tight lg:leading-snug text-[4px] sm:text-[9px]">
                    ...
                    <div className="mt-8 w-full">
                        <div className="space-y-4 text-[#7C7C7C] font-(family-name:--font-geist-sans) text-xs sm:text-[20px] leading-relaxed text-center w-full max-w-4xl mx-auto">
                            <p>
                                <strong className="font-semibold text-zinc-600">World Federation of Shotokan Karate (WFSK)</strong> was established in 2012 to deliver an authentic and complete martial arts experience. Today, WFSK operates internationally across <strong className="font-semibold text-zinc-600">India, UAE, Qatar, Bahrain, and Portugal</strong>, following global training standards.
                            </p>
                            <p>
                                An ISO 9001:2015 certified federation, WFSK offers training in <strong className="font-semibold text-zinc-600">Karate-Do, self-defense, oriental weapons, and fitness</strong>, led by expert instructors with over 32 years of national and international experience.
                            </p>
                            <p>
                                With authorized certifications, structured gradings, and a strong global network, <strong className="font-semibold text-zinc-600">WFSK is committed to discipline, excellence, and the true spirit of Shotokan Karate.</strong><br />
